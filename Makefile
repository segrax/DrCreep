...
DLibs = `sdl-config --libs` -L/usr/local/lib
...
main :
	$(CC) src/castleManager.cpp src/stdafx.cpp src/creep.cpp src/d64.cpp src/debug.cpp src/builder.cpp src/playerInput.cpp src/Event.cpp 
